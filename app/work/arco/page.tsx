      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        <Reveal delay={90}>
          <h1
            ...
            style={{ fontFamily: "var(--font-newsreader)", fontWeight: 400, fontSize: "clamp(56px, 11vw, 140px)", lineHeight: "1.05em", letterSpacing: "-0.02em" }}
          >
            Arco
          </h1>
        </Reveal>
        <Reveal delay={170} className="flex flex-col items-center">
          <div className="h-[3px] w-12 rounded-full bg-sv-pink mb-7" />
          <p
